            ...
            item {
                Column(
                    modifier = Modifier
                        ...
                        .padding(vertical = MainTheme.spacings.large),
                    horizontalAlignment = Alignment.CenterHorizontally
                ) {
                    // Add your image here
                    Image(
                        painter = painterResource(id = app.k9mail.core.ui.compose.theme.R.drawable.icons8),
                        contentDescription = "We are setting up you email, Hold on !! Good things take time", // Provide a content description for accessibility
                        modifier = Modifier.size(50.dp) // Set the size of the image as per your requirement
                    )
                }
            }
